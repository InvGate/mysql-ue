...
Section "MySQL 8" SEC01
  ...
  File "mysql-installer-community-8.0.37.0.msi"
...
ExecWait "msiexec /quiet /qn /i $\"$PROGRAMFILES\MYSQL\mysql-installer-community-8.0.37.0.msi$\""
ExecWait "$\"$PROGRAMFILES\MYSql\MySQL Installer for Windows\MySQLInstallerConsole.exe$\" community install server;8.0.37;X64:*:port=3306;password=root;win_service_name=MySQL --silent"
SectionEnd
